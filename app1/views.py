...
def course_list(request: HttpRequest) -> HttpRequest:
    # get
    # 获取所有的课程信息
...
# 课程详情
def course_info(request: HttpRequest) -> HttpRequest:
    # 获取url ？后面的参数
...
# 师傅列表
def teacher_list(request: HttpRequest) -> HttpRequest:
    # 获取所有老师信息
...
# 问题列表
def problem_list(request: HttpRequest) -> HttpRequest:
    return render(request, "problem_list.html")


# 学生的我的
def student_my(request: HttpRequest) -> HttpRequest:
    return render(request, "student_my.html")


# 关于我们
def team(request: HttpRequest) -> HttpRequest:
    return render(request, "team.html")


def course_list2(request: HttpRequest) -> HttpRequest:
    # get
    # 获取所有的课程信息
